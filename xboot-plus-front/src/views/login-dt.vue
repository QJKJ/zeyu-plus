<template>
  <Row type="flex" justify="center" align="middle" class="login" @keydown.enter.native="submitLogin">
    ...
    <Row class="header">
      <img :src="core.loginLogo" width="220px" />
      <div class="description">{{core.platformInfo}}</div>
    </Row>
    ...
    <Row class="foot">
      <Row type="flex" justify="space-around" class="help">
        <a class="item" href="https://Zeyu" target="_blank">帮助</a>
        <a class="item" href="https://Zeyu" target="_blank">隐私</a>
        <a class="item" href="https://Zeyu" target="_blank">条款</a>
      </Row>
...
export default {
  ...
  mounted() {
    ...
    this.showAccount();
    this.relatedLogin();
    if(this.core.isShowShades==0){
       common.initWindowShades();
    }
    //设置版权信息
    $(".copyright").append(this.core.copyright);
  }
};
</script>
