                ...
                <Card>
                    <p slot="title" class="card-title">
                        ...
                        <a href="https://github.com/Exrick/x-boot" target="_blank">
                            {{ core.platformName }} Github开源版本地址
                                        </a>
                    </p>
                    <p slot="extra">
                        <a target="_blank" href="http://exrick.cn">作者：Zeyu</a>
                    </p>
                    <div class="to-do-list-con">
                        <Timeline>
<!--                            <TimelineItem>
                                <Icon type="logo-youtube" color="#fb7299" slot="dot"></Icon>
                                <a @click="showVideo=true">作者亲自制作文字快闪宣传片 点我观看
                                                </a>
                            </TimelineItem>
                            <TimelineItem>
                                <Icon type="logo-youtube" color="#fb7299" slot="dot"></Icon>
                        ...
                        <Card>
                            <p slot="title" class="card-title" style="overflow:visible">
                                <a href="#" target="_blank">
                                    ...
                                    <Badge dot>立即获取 {{ core.platformName }} 完整版</Badge>
                                </a>
                            </p>
...
<!--                                <div class="qr">
                                ...
                                <div class="flex">
                                    商用授权价格：
                                    <span class="rmb">￥</span> <span class="price">2998</span> 
...
<script>
import { ipInfo,coreParameter } from "@/api/index";
